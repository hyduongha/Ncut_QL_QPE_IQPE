...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/TestK5/" + name
    excel_path = os.path.join("/content/drive/MyDrive/TestK5/log"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Vector = os.path.join("/content/drive/MyDrive/TestK5/logVector"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Eig = os.path.join("/content/drive/MyDrive/TestK5/logEig"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/TestK5/out"+numbers[0]
